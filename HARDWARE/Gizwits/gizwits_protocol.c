...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagLed_OnOff_Change)
    {
        info->event[info->num] = EVENT_Led_OnOff_Change;
        info->num++;
    ...
    if(0x01 == issuedData->attrFlags.flagdata1)
    {
        ...
        info->num++;
        dataPoints->valuedata1 = gizX2Y(data1_RATIO,  data1_ADDITION, exchangeBytes(issuedData->attrVals.valuedata1));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagdata2)
    {
        ...
        info->num++;
        dataPoints->valuedata2 = gizX2Y(data2_RATIO,  data2_ADDITION, exchangeBytes(issuedData->attrVals.valuedata2));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagdata3)
    {
        ...
        info->num++;
        dataPoints->valuedata3 = gizX2Y(data3_RATIO,  data3_ADDITION, exchangeBytes(issuedData->attrVals.valuedata3));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagdata4)
    {
        ...
        info->num++;
        dataPoints->valuedata4 = gizX2Y(data4_RATIO,  data4_ADDITION, exchangeBytes(issuedData->attrVals.valuedata4));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagdata5)
    {
        ...
        info->num++;
        dataPoints->valuedata5 = gizX2Y(data5_RATIO,  data5_ADDITION, exchangeBytes(issuedData->attrVals.valuedata5));
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueLed_OnOff_Change != cur->valueLed_OnOff_Change)
    {
    ...
    if(last->valueread1 != cur->valueread1)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueread1 Changed\n");
            ret = 1;
        }
    }
    if(last->valueread2 != cur->valueread2)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueread2 Changed\n");
            ret = 1;
        }
    }
    if(last->valueread3 != cur->valueread3)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueread3 Changed\n");
            ret = 1;
        }
    }
    if(last->valueread4 != cur->valueread4)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueread4 Changed\n");
            ret = 1;
        }
    }
    if(last->valueread5 != cur->valueread5)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueread5 Changed\n");
            ret = 1;
        }
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    devStatusPtr->valuedata1 = exchangeBytes(gizY2X(data1_RATIO,  data1_ADDITION, dataPoints->valuedata1)); 
    devStatusPtr->valuedata2 = exchangeBytes(gizY2X(data2_RATIO,  data2_ADDITION, dataPoints->valuedata2)); 
    devStatusPtr->valuedata3 = exchangeBytes(gizY2X(data3_RATIO,  data3_ADDITION, dataPoints->valuedata3)); 
    devStatusPtr->valuedata4 = exchangeBytes(gizY2X(data4_RATIO,  data4_ADDITION, dataPoints->valuedata4)); 
    devStatusPtr->valuedata5 = exchangeBytes(gizY2X(data5_RATIO,  data5_ADDITION, dataPoints->valuedata5)); 
    ...
    devStatusPtr->valueread1 = exchangeBytes(gizY2X(read1_RATIO,  read1_ADDITION, dataPoints->valueread1)); 
    devStatusPtr->valueread2 = exchangeBytes(gizY2X(read2_RATIO,  read2_ADDITION, dataPoints->valueread2)); 
    devStatusPtr->valueread3 = exchangeBytes(gizY2X(read3_RATIO,  read3_ADDITION, dataPoints->valueread3)); 
    devStatusPtr->valueread4 = exchangeBytes(gizY2X(read4_RATIO,  read4_ADDITION, dataPoints->valueread4)); 
    devStatusPtr->valueread5 = exchangeBytes(gizY2X(read5_RATIO,  read5_ADDITION, dataPoints->valueread5)); 
